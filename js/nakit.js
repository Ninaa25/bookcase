$(document).ready(function(){
    $("#posalji_nakit").on('click',function(e){
        e.preventDefault();
        var korisnicko_ime_nakit=$('#ime_nakit').val();
        var komentar_nakit=$('#komentar_nakit').val();
        ...
        if(korisnicko_ime_nakit!="" && komentar_nakit!="" && ocena_nakit!=""){
            $.ajax({
                ...
                data:{
                    ...
                    komentar_nakit: komentar_nakit,
                    ocena_nakit: ocena_nakit
                },
                cache: false,
